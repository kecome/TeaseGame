...
/**
 * @Auther: ZouLiFu
 * @Date: 2018/5/28 14:11
 * @Description: 上传阿里云工具类
 */
public class OSSClientUtil {

    Log log = LogFactory.getLog(OSSClientUtil.class);
    protected static String endpoint = "http://oss-cn-shenzhen.aliyuncs.com";
    protected static String accessKeyId  = "LTAIjj6tR5dDvDXQ";
    protected static String accessKeySecret  = "tyvw5tNmsfRVn0E7NKEcbztSELA2C5";
    protected static String bucketName  = "lywx-ywdata";
    private String filedir = "liaowanplatform/head_img/";//头像上传文件夹
